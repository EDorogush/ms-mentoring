...
import com.home.ms.product.purchasehistory.service.PurchaseHistoryService;
...
public class PurchaseHistoryController {
    ...
    @RequestMapping
    public List<PurchaseHistoryItem> getPurchaseHistory(@RequestParam @Nullable String userIdFromParam) {
    ...
    public void deleteItem(@PathVariable String gameId, @RequestParam @Nullable String userIdFromParam) {
        final String userId = getUserId(userIdFromParam);
